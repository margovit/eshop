...
import MalfiniLogo from '../images/malfini.svg';
        ...
        >
            <div className='flex justify-between items-center'>
                <div className='ml-6rem flex items-center'>
                    <Link to='/'>
                        <img src={MalfiniLogo} className='w-30 h-30 mt-4' />
                    </Link>
                    <div onClick={toggleSidebar} className='cursor-pointer' style={{ paddingLeft: '60%' }}>
                        <div className='flex items-center relative'>
                            ...
                            <div>
                                <svg
                                    ...
                                    width='20'
                                    height='20'
                                    style={{ marginRight: '2244px', fill: '#eb5e28' }}
                                >
